...
object ApCameraConst {
    ...
    object ApCameraPayload {
        ...
        const val AP_CAMERA_ASPECT_RATIO_TYPE: String = "ap_camera_screen_aspect_ration_type_payload_apc"
        ...
        const val AP_CAMERA_OUTPUT_URI_STRING: String = "ap_camera_screen_output_path_uri_string_apc"
    }
